...
GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        'lines': [
            ...
            '· 前排：我方=最靠近敌人的第3列，敌方=最靠近我方的第1列',
            '· 攻击按列选择目标：先打前排列，前排清空后打下一列',
            '· 敌方站位按作用排布：坦克最前排、近战中列、刺客/辅助后排',
    ...
    },
    {
        ...
        'lines': [
            ...
            '· 数值基因对应多条染色体上的「增强区域」：加算区（某碱基越多平加越高）+ 乘算区（某碱基越多倍率指数上涨）',
            '· 增强区域强度随主线任务推进增长（卡牌库→基因报告可查看各染色体区域的构成）',
    ...
    },
    {
        ...
        'lines': [
            ...
            '· 芯片：装备后直接获得技能（不限基因）',
            '· 装备：每部位有★主属性（鞋→速度/生命等专属池抽取，加成大）+ 小词条（不变）',
            '· 史诗以上装备带◆特殊词条：技能伤害+/多选中目标/状态回合+/无视距离限制',
            '· 25%几率为套装件，集齐3~4件触发套装效果（龙裔之怒/冰封之心/暗影之舞/混沌之源）',
    ...
    },
    {
        'title': '🎁 卡牌获取',
        'lines': [
            '· 战斗胜利概率掉落卡牌（18~38%）：技能按关卡分级，越靠后越好，不含抽卡限定',
            '· 抽卡：5个卡池，传说/稀有卡直接进入卡牌库',
            '· 任务/成就奖励高品质卡牌；精灵科技战后自动掉卡',
            '· 繁殖：一切卡牌的基因来源',
        ],
    },
    {
