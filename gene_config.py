...
EQUIPMENT_NAMES = {
    'weapon': {
        'common': ['铁剑','短弓','木杖'], 'uncommon': ['精钢剑','猎弓','橡木杖'],
        'rare': ['寒冰刃','暗影弓','雷光杖'], 'epic': ['龙牙·断罪','鳳凰·涅槃'],
        'legend': ['霜噬·灭','虚空·裂'], 'ancient': ['远古·裁决','湮灭·终章'],
        'mythic': ['混沌·噬星','创世·神谕'], 'chaos': ['✦终焉·万象终结✦','✦无限·零✦'],
    },
    'head': {
        'common': ['布帽','皮盔'], 'uncommon': ['铁盔','羽冠'],
        'rare': ['暗影兜帽','龙鳞盔','冰晶冠'], 'epic': ['圣光之冠','深渊兜帽'],
        'legend': ['不死·王冠'], 'ancient': ['远古·智慧冠'], 'mythic': ['神谕·全知之冠'],
        'chaos': ['✦虚无·无面之冠✦'],
    },
    'body': {
        'common': ['布甲','皮甲'], 'uncommon': ['锁子甲','硬皮甲'],
        'rare': ['暗影斗篷','龙鳞甲','冰霜战甲'], 'epic': ['圣光铠甲','深渊战甲'],
        'legend': ['不朽·铠'], 'ancient': ['远古·守护铠'], 'mythic': ['创世·神甲'],
        'chaos': ['✦虚空·无垢之铠✦'],
    },
    'accessory': {
        'common': ['铜戒','骨链'], 'uncommon': ['银戒','翠玉链'],
        'rare': ['暗影徽记','龙牙坠','冰晶戒'], 'epic': ['圣光护符','深渊之眼'],
        'legend': ['命运·戒'], 'ancient': ['远古·时之沙'], 'mythic': ['神谕·命运之轮'],
        'chaos': ['✦星核·万物之环✦'],
    },
    'boots': {
        'common': ['草鞋','布靴'], 'uncommon': ['皮靴','铁靴'],
        'rare': ['暗影之靴','龙鳞靴','冰霜行者'], 'epic': ['圣光之靴','深渊漫步'],
        'legend': ['疾风·靴'], 'ancient': ['远古·踏空靴'], 'mythic': ['神速·光之翼'],
        'chaos': ['✦时停·虚无之履✦'],
    },
    'special': {
        'common': ['徽章'], 'uncommon': ['银徽章'], 'rare': ['暗影徽','龙之徽'],
        'epic': ['圣光徽','深渊徽'], 'legend': ['命运之徽'],
        'ancient': ['远古·遗物'], 'mythic': ['创世·圣物'],
        'chaos': ['✦起源·万物之源✦'],
    },
}
